...
<%@ taglib prefix="chinacart" tagdir="/WEB-INF/tags/addons/chinacartaddon/responsive/cart" %>
        ...
        <ycommerce:testId code="cart_totalPrice_label">
            <span class="cart-top-totals-amount">
                <c:choose>
                    ...
                    <c:otherwise>
                        <format:price priceData="${cartData.selectedTotalPrice}"/>
...
<%--     <div class="row">
    ...
    <chinacart:cartItems cartData="${cartData}"/>
