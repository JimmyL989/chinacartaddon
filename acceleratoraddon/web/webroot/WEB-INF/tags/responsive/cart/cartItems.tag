...
<label for="selectAllTop">
	<input id="selectAllTop" type="checkbox" class="checkAll" /><spring:theme code="basket.page.selectall" />
</label>
	...
	<div>
		 <ul class="item__list item__list__cart">
        	...
        	<li class="item__list--item">	  		
	                    ...
	                    <c:when test="${not entry.product.multidimensional}" >
	                        ...
	                        <form:form id="updateCartForm${entry.entryNumber}" action="${cartUpdateFormAction}" method="post" commandName="updateQuantityForm${entry.entryNumber}"
	                            ...
	                            <ycommerce:testId code="cart_product_quantity">
									...
									<div id="lowStock${entry.entryNumber}" class="hidden lowStock">
	            ...
	            <ycommerce:testId code="cart_totalProductPrice_label">
	                <div class="item__total js-item-total hidden-xs hidden-sm">
	                    <spring:theme code="basket.page.deposit"/>
...
<label for="selectAllBottom" class="span2 bottom-check" id="footer"><input id="selectAllBottom" type="checkbox" class="checkAll" /><spring:theme code="basket.page.selectall" /></label>
